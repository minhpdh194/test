const LegalTerms = (): JSX.Element => {
    return (
        <div>
            <i><b>Last Updated</b>: April 8, 2025</i>
            <br/>
            <p>Welcome to the 1xMM Telegram Mini-App (the "<b>App</b>"). These Terms of Use (the “<b>Terms</b>”) govern your access to and use of the App, operated 
            by Asagaia Europe LTD (“<b>we</b>”, “<b>us</b>”, or “<b>our</b>”).</p>
            <p>By accessing or using the App, you agree to be bound by these Terms and our Privacy Policy (please read it carefully). If you do not agree to these 
            Terms, do not use the App.</p>
            <br/>
            <h2 className="font-bold">1. Purpose of the App</h2>
            <p>The 1xMM Telegram Mini-App is intended solely as a demonstration and gamified simulation of the mechanics underpinning the 1xMM ecosystem. It is a demo 
            environment and does not represent actual staking, pooling, or token transfers on-chain. Users can receive 1XMM token allocations in the following ways:</p>
            <p> 1. By purchasing stars directly through Telegram</p>
            <p> 2. Based on leaderboard rankings at the end of the fundraising period</p>
            <br/>
            <p>Please refer to our Airdrop / Seed section on our website (www.one-xmm.com) for full details on token allocation and intended fund usage.</p>
            ...
            failures, or loss of access. You use the App at your own risk, and we provide no guarantees regarding the accuracy, completeness, or reliability of the 
            App's content or simulations.</p>
            <br/>
            <p><b>IMPORTANT</b>: The 1XMM token, its distribution, and any on-chain features are managed separately by the 1xMM DAO, a decentralized organization 
            not incorporated under UK law. Asagaia Europe LTD does not issue, sell, or manage 1XMM tokens. The UK company operates independently as a partner focused 
            on marketing, branding, and development of front-facing experiences. Participation in token-related events is subject to separate terms and compliance 
            requirements, and may be restricted in certain jurisdictions, including the UK.</p>
            <br/>
            ...
            <p> - Governed by community guidelines and smart contract conditions</p>
            <br/>
            ...
            <p> - Use bots, scripts, or automation to manipulate outcomes</p>
            <p> - Misrepresent your identity or affiliation</p>
            <p> - Attempt to extract or misuse proprietary information from the App</p>
            <p> - Use multiple accounts per physical person/user</p>
            <br/>
            ...
            body. The seat of arbitration shall be Tortola, BVI, and the language of arbitration shall be English. The decision of the arbitral tribunal shall be final 
            ...
            <p> - Violate Telegram’s own terms or community standards</p>
            <br/>
            ...
            <p> - Final validation by the 1xMM project team</p>
            <br/>
            <p>We reserve the right to restrict access in jurisdictions where such distributions are prohibited, including but not limited to the United States, 
            China, Afghanistan, Algeria, Bangladesh, Bolivia, Egypt, Ghana, Iraq, Kuwait, Libya, Morocco, Myanmar, Nepal, North Macedonia, Qatar, Russia, Saudi Arabia, 
            Sierra Leone, Turkey, Vietnam, and OFAC-sanctioned countries.</p>
            ...
            <br/>
            <p><b>Disclaimer</b>: This App and its content are provided for informational and entertainment purposes only. Nothing contained herein constitutes legal, financial, or investment advice.</p>
        </div>
    )
}
