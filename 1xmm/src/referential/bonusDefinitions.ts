...
export const bonusDefinitions: Array<BonusDefinition> = [
    ...
    createBonusDef(46, BonusTypes.Token, 25_000, BonusTerms.None, 15),
    createBonusDef(47, BonusTypes.Token, 50_000, BonusTerms.None, 20),
    createBonusDef(48, BonusTypes.Token, 100_000, BonusTerms.None, 30),
    createBonusDef(49, BonusTypes.Token, 200_000, BonusTerms.None, 50),
    createBonusDef(50, BonusTypes.Friends, 5, BonusTerms.None, 30),
    createBonusDef(51, BonusTypes.Friends, 10, BonusTerms.None, 50),
    createBonusDef(52, BonusTypes.Friends, 25, BonusTerms.None, 80),
    createBonusDef(53, BonusTypes.Friends, 50, BonusTerms.None, 150),
    createBonusDef(54, BonusTypes.Friends, 100, BonusTerms.None, 200),
];
