...
export const bonusDefinitions: Array<BonusDefinition> = [
    ...
    createBonusDef(26, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 20),
    createBonusDef(27, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 30),
    createBonusDef(28, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 40),
    createBonusDef(29, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 50),
    createBonusDef(30, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 60),
    createBonusDef(31, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 70),
    createBonusDef(32, BonusTypes.CapitalProtection, 1, BonusTerms.Short, 80),
